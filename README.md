...
- [Run Locally - PHP Server](#run-locally-using-phps-builtin-webserver)
- [Run Online - GitHub Pages + Render + Amazon S3](#run-online---frontend-github-pages--backend-render--persistent-storage-amazon-s3)
