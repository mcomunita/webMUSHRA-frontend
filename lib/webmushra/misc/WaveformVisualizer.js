...
function WaveformVisualizer(_variableName, _parent, _stimulus, _showWaveform, _enableLooping, _mushraAudioControl) {
	...
	this.numberEventListener = this.mushraAudioControl.addEventListener(
		function (_event) {
...
WaveformVisualizer.prototype.renderSlider = function () {
	...
	this.slider.get(0).noUiSlider.on(
		'update',
...
WaveformVisualizer.prototype.renderTable = function () {
  ...
  '
	...
	var lowerLim = $(
		'<div id=\'div_lower_limit\'><input type="text" name="name" id="lowerLim" class="limits" data-inline="true" data-mini="true"disabled="disabled"></input></div>'
	)
	var upperLim = $(
		'<div id=\'div_upper_limit\'><input type="text" name="name" id="upperLim" class="limits" data-inline="true" data-mini="true"disabled="disabled"></input></div>'
	)
	...
	this.canvas.addEventListener(
		...
		function (event) {
			if (event.x != undefined) {
				...
				// for Firefox
				var newRegion = this.calculateRegion(
			...
			if (this.enableLooping) {
				if (this.leftRegionPosition != newRegion.left) {
					...
					this.mushraAudioControl.setLoopEnd(
						parseInt(newRegion.right / this.scale + newRegion.left / this.scale)
					)
				}
			} else {
				if (this.leftRegionPosition != newRegion.left) {
...
WaveformVisualizer.prototype.draw = function () {
	...
	this.context.fillRect(
		this.leftRegionPosition,
		(-1 * this.canvas.height) / 2,
		this.rightRegionPosition - this.leftRegionPosition,
