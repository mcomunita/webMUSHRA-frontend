	...
	switch (this.type) {
		case CameraType.PERSPECTIVE:
			this.camera = new THREE.PerspectiveCamera(
				45,
				_parentDomElement.getAttribute('width') / _parentDomElement.getAttribute('height'),
				1,
				10000
			)
			break
		case CameraType.ORTHOGRAPHIC:
			this.camera = new THREE.OrthographicCamera(
				-_parentDomElement.getAttribute('width') / 2,
				_parentDomElement.getAttribute('width') / 2,
				_parentDomElement.getAttribute('height') / 2,
				-_parentDomElement.getAttribute('height') / 2,
				0,
				10000
			)
